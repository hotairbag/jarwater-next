...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    title: metadata?.title || "Jarwater | Motion Studio",
    description: metadata?.description || "High-end motion design, animation, and visual storytelling.",
    icons: {
      icon: "/favicon.svg",
    },
    alternates: {
      canonical: `https://jarwater.com/${locale}`,
      languages: Object.fromEntries(
        locales.map((l) => [l, `https://jarwater.com/${l}`])
      ),
    },
  };
}
